//Bundle with FHIR test instances in FSH format for "Beeld in PGO" testscenario 3
...
* custodian = Reference(Images-Organization-Spaarne) "Stichting Spaarne Gasthuis, Radiologie, Algemeen ziekenhuis"
...
* content[0].attachment.title = "MRI van linker bovenbeen" //title | geen mapping naar dataset
...
* content[0].attachment.url = "https://examplepacs.xis/wado/metadata" //geen mapping naar dataset | verwijst naar een dummy URL op een PACS
...
* context.related[0].identifier.type.coding[0].system = "urn:ietf:rfc:3986"
* context.related[0].identifier.type.coding[0].code = #urn:ihe:iti:xds:2013:accession
* context.related[0].identifier.system = "urn:oid:2.16.528.1.1023.19.1.1" //MedMij OID voor testdoeleinden Beeld in PGO
* context.related[0].identifier.value = "RAD-20250212-47092" //Dummy Accession Number
* type = http://snomed.info/sct#16831000087101 "MRI van linker bovenbeen" //Onderzoek.Verrichting.VerrichtingType
* securityLabel = http://terminology.hl7.org/CodeSystem/v3-Confidentiality#N "Normal" //geen mapping naar dataset
* context.facilityType = http://nictiz.nl/fhir/NamingSystem/organization-type#V6 "Algemeen ziekenhuis" //Zorgaanbieder.OrganisatieType
* context.practiceSetting = http://snomed.info/sct#394734003 "Radiological specialties" //Overgenomen uit de Nictiz IG, moet mogelijk specifieker
* context.sourcePatientInfo = Reference(Images-Patient-De-Graaff) "de Graaff"
