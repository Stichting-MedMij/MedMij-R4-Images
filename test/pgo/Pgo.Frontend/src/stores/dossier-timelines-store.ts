/*  DossierTimelinesStore leverages the DossierStore to provide a collection
    ...
    This store is used by the DossierTimeline.svelte component on dossier page.
*/
import { writable, get, derived, type Readable } from 'svelte/store';
import { dossierStore, type DossierStoreState, type DocumentReferenceContentItem } from './dossier-store';

export const dossierTimelineViewStore = writable<DossierStoreState>({
