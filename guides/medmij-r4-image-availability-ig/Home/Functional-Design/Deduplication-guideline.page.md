...
- Study Instance UID ({{pagelink: LogicalModelsIndex, text: MedMij dataset}}, bbs-medmij-dataelement-4): het unieke identificatienummer van een beeldvormend onderzoek binnen DICOM.
