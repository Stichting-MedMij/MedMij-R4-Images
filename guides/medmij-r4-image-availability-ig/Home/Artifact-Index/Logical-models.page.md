...
- The Logical Models corresponding to the dataset, which we will refer to as *base Logical Models*, contain all functional concepts, including corresponding data type, terminology binding (if applicable) and an id.
