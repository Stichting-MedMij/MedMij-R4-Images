...
| `.content.format` | *1.2.840.10008.5.1.4.1.1.88.59* (`http://dicom.nema.org/resources/ontology/DCMUID`) | Any code from `http://ihe.net/fhir/ValueSet/IHE.FormatCode.codesystem` in ValueSet [FormatCodes](https://simplifier.net/resolve?canonical=http://decor.nictiz.nl/fhir/ValueSet/2.16.840.1.113883.2.4.3.11.60.106.11.7--20131212104106&scope=medmij.fhir.nl.r4.imageavailability@1.0.0-rc.2) | *1.2.840.10008.5.1.4.1.1.88.59* (`http://dicom.nema.org/resources/ontology/DCMUID`) |
| `.context.event[modality]` | Any code from `http://dicom.nema.org/resources/ontology/DCM` in ValueSet [ModalityCombined](https://simplifier.net/resolve?canonical=http://medmij.nl/fhir/ValueSet/ModalityCombined&scope=medmij.fhir.nl.r4.imageavailability@1.0.0-rc.2) | Empty or any code from `http://dicom.nema.org/resources/ontology/DCM` in ValueSet [ModalityCombined](https://simplifier.net/resolve?canonical=http://medmij.nl/fhir/ValueSet/ModalityCombined&scope=medmij.fhir.nl.r4.imageavailability@1.0.0-rc.2) | Any code from `http://dicom.nema.org/resources/ontology/DCM` in ValueSet [ModalityCombined](https://simplifier.net/resolve?canonical=http://medmij.nl/fhir/ValueSet/ModalityCombined&scope=medmij.fhir.nl.r4.imageavailability@1.0.0-rc.2), but often code *OT* |
